...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
          #  SQLALCHEMY_DATABASE_URI='mysql://dt_admin:dt2016@localhost/dreamteam_test'
           SQLALCHEMY_DATABASE_URI = 'mysql://node1:Simple_Super@node1.mysql.pythonanywhere-services.com/node1$dreamteam_db'
        )
        return app
    ...
    def setUp(self):
       ...
       # create test super admin user
        admin = Employee(username="superadmin", password="superadmin2016", is_super_admin=True)
